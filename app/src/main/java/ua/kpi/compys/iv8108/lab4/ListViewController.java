...
public class ListViewController extends Fragment implements MoviesAdapter.OnMovieListener {
    ...
    private void setUpRecyclerView(RecyclerView recyclerView, View view) {
        ...
        adapter = new MoviesAdapter(library, this);
        ...
        ItemTouchHelper.SimpleCallback itemTouchHelperCallback = new
                ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                        ...
                        String notification = "Deleted Movie " + library.get(position).getTitle();
    ...
    private void createLibrary(Context context) {
        ...
        try {
            ...
            for (int i = 0; i < moviesInJSON.length(); i++) {
                ...
                library.add(new Movie(title, year, imdbID, type, imageID));
            }
